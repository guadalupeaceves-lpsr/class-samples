...
# This is a while statement, and it is saying that if the value of the variable guessed_nuber is 
# not the same as the value of the variable random_number, then the rest would print.
while guessed_number != random_number:
# This is an if stateent, and it is saying that if the value of the variable guessed_number is
...
# guessed_number to that number that the user typed in.
	guessed_number = int(raw_input())
# This is sayinig that the value of the variable howmanyroundstakentoguess plus one will be assigned
# to the variable howmanyroundstakentogues, making that number the variable's next value.
