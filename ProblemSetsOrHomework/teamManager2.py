...
# this is asking the user for the info to add to the list
			...
			if user_age == "Age: 13":
				myPlayer = Player(user_name, user_age, user_games, user_goals, AtAge13)
				myPlayer.AddPlayers(AtAge13)
...
# this is asking the user if he/she wants to print all of the players, or some
			print("Do you want to view all of the players? Type 'all' or 'specific'.")
			user_decision_printing = str(raw_input())
			if user_decision_printing == 'all':
				myPlayer.PrintWholePlayers(myPlayersList)
			if user_decision_printing == 'specific':
				print("You will now be viewing specific players.")
				print("All of the following players are players at age 13.")
				myPlayer.PrintWholePlayers(AtAge13)	
	print(" ")
